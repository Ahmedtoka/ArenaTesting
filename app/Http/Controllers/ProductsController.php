...
class ProductsController extends Controller {
    ...
    // {
    //     $product = ProductVariant::where('sku',$barcode)->first();
    //     $lims_product_list_without_variant = $this->productWithoutVariant();

    //     $lims_product_list_with_variant = $this->productWithVariant();

    //     return view('products.print_barcode', compact('lims_product_list_without_variant', 'lims_product_list_with_variant','product'));
    // }
